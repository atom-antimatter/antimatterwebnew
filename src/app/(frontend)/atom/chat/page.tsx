...
export default function AtomChatPage() {
      ...
      <div className="w-main mx-auto py-20 text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold">
            Atom <span className="text-primary">Chat</span>
          </h1>

          <p className="text-xl md:text-2xl opacity-70 max-w-2xl">
            Advanced conversational AI interface. Engage in intelligent,
            context-aware conversations powered by cutting-edge AI.
          </p>
