...
import { HiCurrencyDollar, HiArrowLeft } from "react-icons/hi2";

export default function AtomFinancePage() {
      ...
      <div className="w-main mx-auto py-20 text-center">
        ...
        >
          <div className="w-20 h-20 rounded-full bg-primary/20 flex items-center justify-center">
            <HiCurrencyDollar className="size-10 text-primary" />
          </div>

          <h1 className="text-5xl md:text-7xl font-bold">
            Atom <span className="text-primary">Finance</span>
          </h1>

          <p className="text-xl md:text-2xl opacity-70 max-w-2xl">
            Intelligent financial analysis and insights. Harness AI to make
            data-driven financial decisions with confidence.
          </p>
