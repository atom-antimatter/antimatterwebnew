...
// Modified from ReactBits: output alpha based on line intensity so it can sit on a white background.
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  float a = clamp(max(col.r, max(col.g, col.b)) * 2.0, 0.0, 1.0);
...
export default function FloatingLines({
  linesGradient = ["#7E6AFF", "#AA9DFF", "#2F4BA2", "#E947F5"],
