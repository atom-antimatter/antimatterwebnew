...
const ServiceCardContainer = () => {
  ...
  return (
    <div
      className="flex flex-col items-center gap-8 sm:gap-10 lg:flex-row lg:items-stretch lg:gap-0 w-full max-w-[100vw] lg:max-w-none px-4 lg:px-0 overflow-x-hidden lg:overflow-visible"
      id="service-cards"
    >
